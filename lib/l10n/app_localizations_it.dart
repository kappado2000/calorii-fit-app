...
class AppLocalizationsIt extends AppLocalizations {
  ...
  @override
  String get realNutritionDataBadge => 'dati reali';
  ...
  @override
  String get programStartDateLabel => 'Data di inizio della dieta';

  @override
  String get programStartDateHint =>
      'Diversa dalla data di creazione dell\'account — è il punto da cui misurare i progressi.';
  ...
  String newWorkoutsImported(int count) {
    return '$count nuovi allenamenti importati dal tuo orologio.';
  }
  ...
  @override
  String get searchWithAiButton => 'Cerca con l\'IA';

  @override
  String get notFindingWhatYouWant => 'Non trovi quello che cerchi?';

  @override
  String get aiSearchNoResult =>
      'L\'IA non ha trovato un prodotto affidabile per questa ricerca.';

  @override
  String get aiEstimateBadge => 'stima IA';
  ...
  @override
  String get editGramsDialogTitle => 'Modifica porzione';
  ...
  String get guideLogBody =>
      'Quattro pasti al giorno — Colazione, Pranzo, Cena, Spuntino. Aggiungi alimenti da foto, ricerca, scansione del codice a barre, manualmente, dalle tue ricette o rapidamente da una lista di alimenti abituali. Tocca una voce già registrata per modificarne la quantità. Se una ricerca non trova esattamente ciò che cerchi, tocca \"Cerca con l\'IA\", e per una voce a cui mancano nutrienti, tocca \"Completa con l\'IA\". Puoi selezionare più alimenti già registrati e salvarli come nuova ricetta.';
  ...
  String get guideProgressBody =>
      'Grafici su 7 giorni, 30 giorni o l\'intero programma: evoluzione del peso (levigata), TDEE adattivo calcolato dal tuo bilancio energetico reale, bilancio dei macronutrienti e copertura dei micronutrienti. Sincronizzazione con Apple Salute / Health Connect e una bilancia Bluetooth. Se a più voci mancano nutrienti, \"Completa con l\'IA\" li completa tutti in una volta (premium o prova). L\'icona nella barra superiore apre \"Fonti di nutrienti\": gli alimenti che contribuiscono di più, separatamente per macro e micronutrienti.';
  ...
  String get guidePremiumFreeBody =>
      'Gratuito, per sempre: diario alimentare completo, un\'analisi foto al giorno, ricerca illimitata, ricette personali illimitate, grafici di progresso di base e sincronizzazione Apple Salute / Health Connect.';

  @override
  String get guidePremiumPaidBody =>
      'Premium (attivato con un codice): 20 analisi foto al giorno e 20 ricerche AI al giorno per completare automaticamente i nutrienti, più TDEE adattivo e micronutrienti dettagliati.';

  @override
  String get guidePremiumTrialNote =>
      'Account nuovo? Hai una prova di 14 giorni: 3 analisi foto al giorno e fino a 10 ricerche AI incluse, senza codice.';

  @override
  String get guidePremiumRedeemButton => 'Ho un codice premium';
  ...
  @override
  String get accessCodeMenuEntry => 'Codice di accesso';

  @override
  String get adminDashboardMenuEntry => 'Pannello admin';

  @override
  String get accessCodeScreenTitle => 'Codice di accesso';

  @override
  String get premiumCodeFieldLabel => 'Codice premium';

  @override
  String get activatePremiumButton => 'Attiva premium';

  @override
  String premiumActivatedMessage(String date) {
    return 'Accesso premium attivato fino al $date.';
  }

  @override
  String get iAmAdminLink => 'Sono admin';

  @override
  String get adminPasswordFieldLabel => 'Password admin';

  @override
  String get adminTotpFieldLabel => 'Codice dall\'app di autenticazione';

  @override
  String get activateAdminButton => 'Attiva admin';

  @override
  String get adminActivatedMessage => 'Account admin attivato.';

  @override
  String get adminDashboardTitle => 'Pannello admin';

  @override
  String get totalUsersLabel => 'Utenti totali';

  @override
  String get activePremiumLabel => 'Premium attivo';

  @override
  String get generateCodeSectionTitle => 'Genera codice premium';

  @override
  String get targetEmailLabel => 'Email account';

  @override
  String get durationDaysLabel => 'Durata (giorni)';

  @override
  String get generateCodeButton => 'Genera codice';

  @override
  String get codeGeneratedTitle => 'Codice generato';

  @override
  String get generatedCodesSectionTitle => 'Codici generati';

  @override
  String get noCodesGeneratedYet => 'Nessun codice generato ancora.';

  @override
  String get codeStatusPending => 'non utilizzato';

  @override
  String get codeStatusRedeemed => 'utilizzato';

  @override
  String get codeStatusRevoked => 'revocato';
  ...
  @override
  String get nutrientSourcesTitle => 'Fonti di nutrienti';

  @override
  String get macroSourcesSectionTitle => 'Macronutrienti';

  @override
  String get micronutrientSourcesSectionTitle => 'Micronutrienti';

  @override
  String get nutrientSourcesNoData => 'Dati insufficienti per questo periodo.';

  @override
  String get nutrientSourcesOthers => 'altri alimenti';
}
