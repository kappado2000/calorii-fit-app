...
class AppLocalizationsPt extends AppLocalizations {
  ...
  String get cameraQuotaExceededMessage =>
      'Atingiste o limite diário de análises de fotos. Ativa premium para mais análises por dia.';
  ...
  @override
  String get notFindingWhatYouWant => 'Não encontras o que procuras?';
  ...
  String get guideLogBody =>
      'Quatro refeições por dia — Café da manhã, Almoço, Jantar, Lanche. Adicione alimentos por foto, busca, leitura de código de barras, manualmente, das suas receitas ou rapidamente por uma lista de alimentos frequentes. Toque em uma entrada já registrada para editar a quantidade. Se uma busca não encontrar exatamente o que você procura, toque em \"Pesquisar com IA\", e em uma entrada com nutrientes faltando, toque em \"Completar com IA\". Você pode selecionar vários alimentos já registrados e salvá-los como uma nova receita.';
  ...
  String get guideProgressBody =>
      'Gráficos de 7 dias, 30 dias ou todo o programa: evolução do peso (suavizada), GET adaptativo calculado a partir do seu próprio equilíbrio energético, equilíbrio de macronutrientes e cobertura de micronutrientes. Sincroniza com Apple Saúde / Health Connect e uma balança Bluetooth. Se várias entradas estiverem com nutrientes faltando, \"Completar com IA\" completa todas de uma vez (premium ou período de teste). O ícone na barra superior abre \"Fontes de nutrientes\": os alimentos que mais contribuem, separadamente para macro e micronutrientes.';
  ...
  String get guidePremiumFreeBody =>
      'Grátis, para sempre: diário alimentar completo, uma análise de foto por dia, busca ilimitada, receitas próprias ilimitadas, gráficos de progresso básicos e sincronização com Apple Saúde / Health Connect.';

  @override
  String get guidePremiumPaidBody =>
      'Premium (ativado com um código): 20 análises de fotos por dia e 20 buscas com IA por dia para completar automaticamente os nutrientes, além de GET adaptativo e micronutrientes detalhados.';

  @override
  String get guidePremiumTrialNote =>
      'Conta nova? Você tem um período de teste de 14 dias: 3 análises de fotos por dia e até 10 buscas com IA incluídas, sem código.';

  @override
  String get guidePremiumRedeemButton => 'Tenho um código premium';
  ...
  @override
  String get accessCodeMenuEntry => 'Código de acesso';

  @override
  String get adminDashboardMenuEntry => 'Painel de administração';

  @override
  String get accessCodeScreenTitle => 'Código de acesso';

  @override
  String get premiumCodeFieldLabel => 'Código premium';

  @override
  String get activatePremiumButton => 'Ativar premium';

  @override
  String premiumActivatedMessage(String date) {
    return 'Acesso premium ativado até $date.';
  }

  @override
  String get iAmAdminLink => 'Sou admin';

  @override
  String get adminPasswordFieldLabel => 'Palavra-passe de admin';

  @override
  String get adminTotpFieldLabel => 'Código da app de autenticação';

  @override
  String get activateAdminButton => 'Ativar admin';

  @override
  String get adminActivatedMessage => 'Conta de admin ativada.';

  @override
  String get adminDashboardTitle => 'Painel de administração';

  @override
  String get totalUsersLabel => 'Utilizadores totais';

  @override
  String get activePremiumLabel => 'Premium ativo';

  @override
  String get generateCodeSectionTitle => 'Gerar código premium';

  @override
  String get targetEmailLabel => 'Email da conta';

  @override
  String get durationDaysLabel => 'Duração (dias)';

  @override
  String get generateCodeButton => 'Gerar código';

  @override
  String get codeGeneratedTitle => 'Código gerado';

  @override
  String get generatedCodesSectionTitle => 'Códigos gerados';

  @override
  String get noCodesGeneratedYet => 'Ainda não há códigos gerados.';

  @override
  String get codeStatusPending => 'não utilizado';

  @override
  String get codeStatusRedeemed => 'utilizado';
  ...
  @override
  String get completeNutritionWithAiTooltip => 'Completar com IA';

  @override
  String get nutritionCompletedMessage => 'Dados nutricionais completados.';

  @override
  String get aiCompletionNoResult =>
      'A IA não encontrou dados fiáveis para este alimento.';

  @override
  String bulkNutritionCompletionButton(int count) {
    return 'Completar com IA ($count)';
  }
  ...
  String bulkNutritionCompletionPremiumLocked(int count) {
    return 'Funcionalidade premium ($count alimentos)';
  }
