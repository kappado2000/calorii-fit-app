...
class AppLocalizationsDa extends AppLocalizations {
  ...
  String get cameraQuotaExceededMessage =>
      'Du har nået dagens grænse for fotoanalyser. Aktivér premium for flere analyser om dagen.';
  ...
  @override
  String get realNutritionDataBadge => 'reelle data';
  ...
  @override
  String get notFindingWhatYouWant => 'Finder du ikke det, du leder efter?';
  ...
  String get guideLogBody =>
      'Fire måltider om dagen — Morgenmad, Frokost, Aftensmad, Snack. Tilføj mad via billede, søgning, stregkodescanning, manuelt, fra dine opskrifter eller hurtigt fra en afkrydsningsliste med din sædvanlige mad. Tryk på en registreret post for at redigere mængden. Hvis en søgning ikke finder præcis det, du leder efter, så tryk på \"Søg med AI\", og for en post, der mangler næringsstoffer, tryk på \"Udfyld med AI\". Du kan vælge flere allerede registrerede fødevarer og gemme dem som en ny opskrift.';
  ...
  String get guideProgressBody =>
      'Grafer over 7 dage, 30 dage eller hele programmet: vægtudvikling (udjævnet), adaptivt TDEE beregnet ud fra din egen energibalance, makronæringsbalance og dækning af mikronæringsstoffer. Synkroniserer med Apple Health / Health Connect og en Bluetooth-vægt. Hvis flere poster mangler næringsstoffer, udfylder \"Udfyld med AI\" dem alle på én gang (premium eller prøveperiode). Ikonet i topbjælken åbner \"Næringskilder\": hvilke fødevarer der bidrager mest, hver for sig for makro- og mikronæringsstoffer.';
  ...
  String get guidePremiumFreeBody =>
      'Gratis, for altid: fuldstændig maddagbog, én fotoanalyse om dagen, ubegrænset søgning, ubegrænsede egne opskrifter, grundlæggende fremskridtsgrafer og synkronisering med Apple Health / Health Connect.';

  @override
  String get guidePremiumPaidBody =>
      'Premium (aktiveret med en kode): 20 fotoanalyser om dagen og 20 AI-søgninger om dagen til automatisk udfyldning af næringsstoffer, plus adaptivt TDEE og detaljerede mikronæringsstoffer.';

  @override
  String get guidePremiumTrialNote =>
      'Ny konto? Du får en 14-dages prøveperiode: 3 fotoanalyser om dagen og op til 10 AI-søgninger inkluderet, uden kode.';

  @override
  String get guidePremiumRedeemButton => 'Jeg har en premiumkode';
  ...
  @override
  String get accessCodeMenuEntry => 'Aktiveringskode';

  @override
  String get adminDashboardMenuEntry => 'Adminpanel';

  @override
  String get accessCodeScreenTitle => 'Aktiveringskode';

  @override
  String get premiumCodeFieldLabel => 'Premiumkode';

  @override
  String get activatePremiumButton => 'Aktivér premium';

  @override
  String premiumActivatedMessage(String date) {
    return 'Premiumadgang aktiveret indtil $date.';
  }

  @override
  String get iAmAdminLink => 'Jeg er admin';

  @override
  String get adminPasswordFieldLabel => 'Adminadgangskode';

  @override
  String get adminTotpFieldLabel => 'Kode fra autentificeringsappen';

  @override
  String get activateAdminButton => 'Aktivér admin';

  @override
  String get adminActivatedMessage => 'Adminkonto aktiveret.';

  @override
  String get adminDashboardTitle => 'Adminpanel';

  @override
  String get totalUsersLabel => 'Brugere i alt';

  @override
  String get activePremiumLabel => 'Aktiv premium';

  @override
  String get generateCodeSectionTitle => 'Generér premiumkode';

  @override
  String get targetEmailLabel => 'Kontoens e-mail';

  @override
  String get durationDaysLabel => 'Varighed (dage)';

  @override
  String get generateCodeButton => 'Generér kode';

  @override
  String get codeGeneratedTitle => 'Kode genereret';

  @override
  String get generatedCodesSectionTitle => 'Genererede koder';

  @override
  String get noCodesGeneratedYet => 'Ingen koder genereret endnu.';

  @override
  String get codeStatusPending => 'ubrugt';

  @override
  String get codeStatusRedeemed => 'brugt';

  @override
  String get codeStatusRevoked => 'tilbagekaldt';
  ...
  @override
  String get completeNutritionWithAiTooltip => 'Udfyld med AI';

  @override
  String get nutritionCompletedMessage => 'Ernæringsdata udfyldt.';

  @override
  String get aiCompletionNoResult =>
      'AI fandt ikke sikre data for denne fødevare.';

  @override
  String bulkNutritionCompletionButton(int count) {
    return 'Udfyld med AI ($count)';
  }
  ...
  String bulkNutritionCompletionPremiumLocked(int count) {
    return 'Premiumfunktion ($count fødevarer)';
  }
